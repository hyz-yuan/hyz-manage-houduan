...
public class TechnologyController {
    ...
    @ResponseBody
    public CommonReturnType selectTechnology(){
    ...
    @ResponseBody
    public CommonReturnType updateTechnology(@RequestBody Technology technology){
    ...
    @ResponseBody
    public CommonReturnType insertNewTechnology(@RequestBody Technology technology){
    ...
    @ResponseBody
    public CommonReturnType deleteNewTechnology(@RequestBody Technology delTechnology){
